...
<script type="text/javascript" src="jquery/bootstrap_3.3.0/js/bootstrap.min.js"></script>
	...
	//在页面加载完毕后，展现市场活动关联的备注信息列表
		...
		function showActivityList(){
		 ...
		 html+='font color="gray">市场活动</font> <font color="gray">-</font> <b>${n.name}</b> <small style="color: gray;"> "+(n.editFlag==0?n.creatTime:n.editTime)+" 由(n.editFlag==0?n.creatBy:n.editBy) </small>';
